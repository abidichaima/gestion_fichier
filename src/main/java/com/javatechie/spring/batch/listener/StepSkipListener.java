...
public class StepSkipListener implements SkipListener<Batch, Number> {
    ...
    public void onSkipInProcess(Batch batch, Throwable throwable) {
        logger.info("Item {}  was skipped due to the exception  {}", new ObjectMapper().writeValueAsString(batch),
